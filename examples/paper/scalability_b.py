...
traffic_list = ["--traffic none", "--traffic point_to_point_eos --traffic-scale 1", "--traffic point_to_point_eos --traffic-scale 100", "--traffic point_to_point_eos --traffic-scale 10000"]
scenario_list = ["walker_large"]
walker_scale_list = [32]

# Define the output file
output_file = "out/scalability_results_b.csv"
